...
<body>
<h1>Videos</h1>
<p><a href="video_edit.php">Add New</a> | <a href="index.php">Back to Admin</a></p>
<table class="album-list">
<thead>
<tr><th>Thumb</th><th>Title</th><th>Artist</th><th>Order</th><th>Actions</th></tr>
</thead>
<tbody>
<?php foreach ($rows as $r): ?>
<tr>
    <td><?php if ($r['thumbnail']): ?><img src="<?= htmlspecialchars(cache_bust('/videos/' . $r['slug'] . '/' . $r['thumbnail'])) ?>" alt="thumb" height="50"><?php endif; ?></td>
    <td><?= htmlspecialchars($r['title']) ?></td>
    <td><?= htmlspecialchars($r['artist']) ?></td>
    <td><?= (int)$r['video_order'] ?></td>
    <td>
        <a href="video_edit.php?slug=<?= urlencode($r['slug']) ?>">Edit</a>
        <form action="delete_video.php" method="post" style="display:inline" onsubmit="return confirm('Delete this entry?');">
