  ...
  if ($name && $email && $message && $token) {
    ...
    if (
      ...
      $mailResult = echopress_mail([
        ...
        'subject' => $subject,
        'text' => $bodyContent,
        'html' => nl2br(htmlspecialchars($bodyContent, ENT_QUOTES, 'UTF-8')),
...
$pageMeta = get_page_meta($pdo, '/contact/index.php');
$metaTitle = $pageMeta['title'] ?? 'Contact';
$metaDesc = $pageMeta['description'] ?? ('Get in touch with ' . $siteName . '.');
...
<?php
  ...
  <meta property="og:url" content="<?= htmlspecialchars($host . '/contact/') ?>">
...
<body>
  ...
  <main class="container">
    ...
    <p>Use this form for booking, collaborations, licensing, or thoughtful feedback. Messages go directly to the EchoPress admin inbox configured for this site.</p>
